...
function ConfirmUnstaking({
    ...
    return (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
            <div className="bg-[#17043B] border border-primary/50 clip-path-polygon w-full max-w-md p-6 transform transition-all duration-300 scale-95 hover:scale-100">
                <h2 className="text-white text-2xl font-bold mb-6 text-center">Confirm Withdraw</h2>

                <div className="space-y-4">
                    <div className="bg-[#291254]/80 p-4 clip-path-polygon border border-primary/20 space-y-2">
                    ...
                    <div className="bg-[#291254]/80 p-4 clip-path-polygon border border-primary/20">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-white bg-[#291254]/50 p-4 clip-path-polygon border border-primary/10">
                        <div>
                ...
                {!lockStake && (
                    <div className="space-x-2 flex items-center my-3">
                        ...
                        <input
                            ...
                            id="unstake"
                            checked={unstake}
                            className="h-5 w-5 accent-primary clip-path-polygon border-2 border-primary/50 focus:ring-primary focus:ring-offset-2 focus:ring-2 transition-all duration-200 cursor-pointer"
                ...
                <div className="mt-8 space-y-3">
                    {!authenticated ? (
                        <button
                            onClick={login}
                            className="bg-primary/90 hover:bg-primary w-full py-3 clip-path-polygon text-white font-medium flex items-center justify-center space-x-2 transition-all duration-200 hover:scale-[1.02] active:scale-95"
                        >
                        ...
                        <>
                            <button
                                ...
                                disabled={loading}
                                className="bg-primary/90 hover:bg-primary w-full py-3 clip-path-polygon text-white font-medium flex items-center justify-center transition-all duration-200 hover:scale-[1.02] active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
                            >
                                {loading ? (
                                    <Preloader
                                        use={Oval}
                    ...
                    <button
                        onClick={onClose}
                        className="w-full py-2.5 text-[#C4C4C4] hover:text-white clip-path-polygon hover:bg-white/5 transition-colors duration-200"
                    >
                        Cancel
                    </button>
                </div>
